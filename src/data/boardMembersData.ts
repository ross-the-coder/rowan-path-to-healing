// Static fallback data for board members when Sanity is unavailable
...
export const boardOfficers: BoardMember[] = [
  {
    _id: "officer-1",
...
export const allBoardMembers: BoardMember[] = [...boardOfficers, ...boardMembers];
