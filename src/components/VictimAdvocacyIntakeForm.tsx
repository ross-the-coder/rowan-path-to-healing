...
const translations = {
  en: {
    title: "Request Advocacy Services",
...
interface VictimAdvocacyIntakeFormProps {
  language?: "en" | "es";
}

export const VictimAdvocacyIntakeForm = ({ language = "en" }: VictimAdvocacyIntakeFormProps) => {
  ...
  return (
    <Card className="max-w-3xl mx-auto bg-secondary/5 border-secondary/20">
      <CardHeader>
