    ...
    <Layout>
      ...
      <section className="relative min-h-[620px] flex items-end overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-x-0 bottom-0 h-56 bg-gradient-to-t from-[#386a8e] to-transparent"></div>
        </div>
      </section>

      <section className="bg-gradient-to-br from-[#386a8e] via-[#386a8e] to-[#4ca9c4] text-white">
        <div className="container mx-auto px-4 pt-16 pb-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-seasons font-bold mb-12">
              Support our mission
            </h1>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white text-foreground rounded-2xl p-8 md:p-12 shadow-2xl shadow-[rgba(0,0,0,0.25)] border border-white/60 -mt-2 relative z-10">
              <div className="flex flex-col items-center text-center">
                <Heart className="h-12 w-12 text-[#4ca9c4] mb-6" />
                ...
                <Button className="bg-[#4ca9c4] hover:bg-[#4ca9c4]/90" size="lg" asChild>
                  <a href={DONATE_URL}>Donate Now</a>
                </Button>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-seasons font-normal mb-6 text-[#386a8e]">Your Impact</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
            <Card className="text-center border border-[#386a8e]/15 shadow-lg shadow-[rgba(56,106,142,0.18)]">
              <CardContent className="p-6">
                <div className="text-4xl font-seasons font-bold text-[#4ca9c4] mb-2">24/7</div>
            ...
            <Card className="text-center border border-[#386a8e]/15 shadow-lg shadow-[rgba(56,106,142,0.18)]">
              <CardContent className="p-6">
                <div className="text-4xl font-seasons font-bold text-[#4ca9c4] mb-2">Free</div>
                <p className="font-roboto text-muted-foreground">
            ...
            <Card className="text-center border border-[#386a8e]/15 shadow-lg shadow-[rgba(56,106,142,0.18)]">
              <CardContent className="p-6">
                <div className="text-4xl font-seasons font-bold text-[#4ca9c4] mb-2">Confidential</div>
                <p className="font-roboto text-muted-foreground">
        ...
        <section className="mb-16">
          <div className="max-w-5xl mx-auto">
            <div className="rounded-lg overflow-hidden shadow-xl shadow-[rgba(56,106,142,0.2)] border border-[#386a8e]/10">
              <img 
        ...
        <section className="mb-16">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl font-seasons font-normal text-center mb-12 text-[#386a8e]">Ways to Give</h2>
            
            <div className="grid md:grid-cols-3 gap-8">
              {/* Make a Donation */}
              <Card className="hover:shadow-xl transition-shadow flex flex-col border border-[#386a8e]/15 shadow-lg shadow-[rgba(56,106,142,0.18)]">
                <CardHeader className="text-center">
                  <CreditCard className="h-12 w-12 text-[#4ca9c4] mx-auto mb-3" />
                ...
                <CardContent className="flex-1 flex flex-col">
                  ...
                  <Button className="w-full bg-[#4ca9c4] hover:bg-[#4ca9c4]/90" size="lg" asChild>
                    <a href={DONATE_URL}>
                      Donate Now
                    </a>
                  </Button>
              ...
              <Card className="hover:shadow-xl transition-shadow flex flex-col border border-[#386a8e]/15 shadow-lg shadow-[rgba(56,106,142,0.18)]">
                <CardHeader className="text-center">
                  <Landmark className="h-12 w-12 text-[#4ca9c4] mx-auto mb-3" />
                ...
                <CardContent className="flex-1 flex flex-col">
                  ...
                  <div className="w-full flex justify-center">
                    {isChariotReady && CHARIOT_BUTTON_CID ? (
                      ...
                      <Button asChild className="w-full bg-[#4ca9c4] hover:bg-[#4ca9c4]/90">
              ...
              <Card className="hover:shadow-xl transition-shadow flex flex-col border border-[#386a8e]/15 shadow-lg shadow-[rgba(56,106,142,0.18)]">
                <CardHeader className="text-center">
                  <PiggyBank className="h-12 w-12 text-[#4ca9c4] mx-auto mb-3" />
                ...
                <CardContent className="flex-1 flex flex-col">
                  ...
                  <Button className="w-full border-[#386a8e] text-[#386a8e] hover:bg-[#386a8e]/10" size="lg" variant="outline">
        ...
        <section>
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl font-seasons font-normal text-center mb-12 text-[#386a8e]">Other Ways to Help</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="overflow-hidden hover:shadow-xl transition-shadow border border-[#386a8e]/15 shadow-lg shadow-[rgba(56,106,142,0.18)]">
                ...
                <CardContent className="p-6 text-center">
                  ...
                  <Button variant="outline" className="border-[#386a8e] text-[#386a8e] hover:bg-[#386a8e]/10" asChild>
        ...
        <section className="mt-16">
          <div className="max-w-4xl mx-auto">
            <Card className="border border-[#386a8e]/15 shadow-lg shadow-[rgba(56,106,142,0.18)]">
              <CardContent className="p-8 text-center">
                ...
                <p className="font-roboto text-muted-foreground mb-6">
                  <strong>Email:</strong>{" "}
                  <a href="mailto:info@therowancenter.org" className="text-[#386a8e] hover:underline">
