      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {leadershipTeam.map((member, index) => <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardHeader>
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    {member.phone && <a href={`tel:${member.phone}`} className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {staffMembers.map((member, index) => <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="flex items-start gap-4">
