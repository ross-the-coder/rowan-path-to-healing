...
async function importStaff() {
  ...
  const staffMembers = [
    ...
    { name: "Isabel Negron, LCSW", title: "Assistant Clinical Director", email: "inegron@traumarecoveryct.org", category: "staff", order: 14 },
    { name: "Kathy Miranda", title: "Community Educator (EN/ES)", email: "kmiranda@therowancenter.org", category: "staff", order: 15 },
    { name: "Raquel Lopez, LMSW", title: "Crisis Advocate Programs Administrator", email: "rlopez@therowancenter.org", category: "staff", order: 16 },
