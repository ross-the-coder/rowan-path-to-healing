  ...
  return escapeInject`<!DOCTYPE html>
    <html lang="en">
      <head>
        ...
        window.loadReciteService = loadService;
        window.loadService = loadService;

        document.addEventListener("DOMContentLoaded", function () {
          var button = document.getElementById("enableRecite");
          if (!button) return;
        ...
        ${dangerouslySkipEscape(`<script>
        document.addEventListener("DOMContentLoaded", function () {
          var trigger = document.getElementById("enableRecite");
          if (!trigger || typeof loadService !== "function") return;
